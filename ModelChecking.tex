...
\item {In software engineering, one of the great benefits of Alloy is that you can analyze a tiny model, write three lines, and analyze it, add few more lines and analyze again. This increment makes Alloy especially good for exploring design ideas. }\cite{ErichGamma1995}
\end{itemize}
...
This report mainly consists of three parts. Part I is the literature survey, Part II is the Alloy Analyser Example and part III is the Theoretical background required for the project.
...
\chapte{Running The Alloy Analyser With Example: Coffee Machine}
